...
ActiveRecord::Schema.define(version: 20150605151104) do
  ...
  add_index "comments", ["authorable_type", "authorable_id"], name: "index_comments_on_authorable_type_and_authorable_id", using: :btree
